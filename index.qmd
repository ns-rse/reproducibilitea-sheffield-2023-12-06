...
4. Replication estimate of 86% is across all studies, normally meta-analysis is conducted within study to say whether it
   replicates.  ([Bak-Coleman & Devezer](https://europepmc.org/article/PPR/PPR763078)). More an investigation of False
   Discovery Rate (FDR) ([Jager & Leek](https://academic.oup.com/biostatistics/article/15/1/1/244509))
...
of how effective the practices are. Really this is more an estimate of the False Discovery Rate
:::
